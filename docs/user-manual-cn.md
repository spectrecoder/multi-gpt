...
本文档用于解释 Commune Multi ChatGPT 的部分功能介绍和设计原则。
...
1. 在 Commune Multi ChatGPT 中配置好一个面具；
...
- 注入系统级提示信息、用户输入预处理：详情请看 [https://github.com/hercles321/Commune-MultiChatGPT/issues/2144](https://github.com/hercles321/Commune-MultiChatGPTissues/2144)
